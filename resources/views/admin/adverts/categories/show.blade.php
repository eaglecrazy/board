...
@section('content')
    ...
    <div class="card p-3  mb-3">
        <h2>Атрибуты</h2>
        <div class="d-flex flex-row mb-3">
            <a href="{{ route('admin.adverts.categories.attributes.create', $category) }}" class="btn btn-primary mr-1">Добавить
                атрибут для категории</a>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered table-striped ">
                <thead>
    ...
    <div class="card p-3  mb-3">
        ...
        <div class="d-flex flex-row mb-3">
            <a href="{{ route('admin.adverts.categories.create-inner', $category) }}" class="btn btn-primary mr-1">Создать
                дочернюю категорию</a>
        </div>
